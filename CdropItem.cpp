...
void CdropItem::makeFinalItem(float x, float y)
{
	...
	finalItem.itemRect = RectMake(x - 50, y + 100, IMAGE->findImage(finalItem.item->getSmallImage())->getFrameWidth(),
	...
	finalItem2.itemRect = RectMake(x + 50, y + 50, IMAGE->findImage(finalItem2.item->getSmallImage())->getFrameWidth(),
	...
	finalItem3.itemRect = RectMake(x + 150, y + 100, IMAGE->findImage(finalItem3.item->getSmallImage())->getFrameWidth(),
	...
	finalItem4.itemRect = RectMake(x, y + 150, IMAGE->findImage(finalItem4.item->getSmallImage())->getFrameWidth(),
	...
	finalItem5.itemRect = RectMake(x + 100, y + 150, IMAGE->findImage(finalItem5.item->getSmallImage())->getFrameWidth(),
