...
HRESULT Cimage::init()
{
    ...
    IMAGE->addFrameImage("퀘스트1", "images/Quest1.bmp", 16, 25, 1, 1, true, RGB(255, 0, 255));
    IMAGE->addFrameImage("퀘스트2", "images/Quest2.bmp", 16, 25, 1, 1, true, RGB(255, 0, 255));
    IMAGE->addFrameImage("퀘스트3", "images/Quest3.bmp", 16, 25, 1, 1, true, RGB(255, 0, 255));
    IMAGE->addFrameImage("퀘스트4", "images/Quest4.bmp", 9, 25, 1, 1, true, RGB(255, 0, 255));
